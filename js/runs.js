        ...
        body: JSON.stringify({
          ...
          messages: [{
            ...
            content: [
              ...
              { type: 'text', text: 'Look at this image. Is this a Strava activity screenshot? Respond ONLY with valid JSON, no markdown, no extra text. Fields: is_strava (boolean), distance_km (number e.g. 2.73), time_seconds (integer total seconds — e.g. '35m 45s'=2145, '1h 02m 30s'=3750), elevation_m (integer or null), name (string or null), date (YYYY-MM-DD or null). If not Strava: is_strava=false, rest null.' }
            ]
          }]
        })
      });
